...
Future<void> pumpBugun(WidgetTester tester, Map<String, dynamic> home) async {
...
void main() {
  ...
  testWidgets('Bugün renders populated /home without exceptions', (tester) async {
    ...
    await pumpBugun(tester, populatedHome());
  ...
  testWidgets('Bugün renders empty/edge /home without exceptions',
    ...
    await pumpBugun(tester, emptyHome());
