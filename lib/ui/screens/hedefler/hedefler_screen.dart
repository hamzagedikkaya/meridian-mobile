...
class HedeflerScreen extends ConsumerStatefulWidget {
  const HedeflerScreen({super.key});

  @override
  ConsumerState<HedeflerScreen> createState() => _HedeflerScreenState();
}

class _HedeflerScreenState extends ConsumerState<HedeflerScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text('Hedefler', style: text.headlineLarge)),
        ...
        if (empty)
          SliverFillRemaining(
            ...
            child: EmptyState(
              ...
              title: 'İlk hedefini koy',
              subtitle: 'Bir hedef belirle, ilerlemeni buradan izle.',
...
/// Collapsed "Başarılanlar" / "Bırakılanlar" section — flat rows.
