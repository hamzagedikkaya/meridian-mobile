...
/// Bolt quick-capture: one field "Ne oldu?" → repository.quickCapture(text).
...
class _QuickCaptureSheetState extends State<_QuickCaptureSheet> {
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      if (!mounted) return;
      setState(() => _submitting = false);
      showAppSnack(context, 'Kayıt eklenemedi', isError: true);
    }
  }
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text('Hızlı kayıt', style: text.titleLarge),
              ...
              TextField(
                ...
                decoration: const InputDecoration(
                  hintText: 'Ne oldu? (−250 kahve, habit: koşu, süt al…)',
                ),
              ),
