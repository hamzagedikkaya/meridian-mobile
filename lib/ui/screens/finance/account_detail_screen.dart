...
class _AccountDetailScreenState extends ConsumerState<AccountDetailScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(account?.name ?? l.titleAccount),
      ),
              ...
              SliverToBoxAdapter(
                child: Padding(
                  ...
                  child: EmptyState(
                    ...
                    title: l.financeNoTransactionsInAccount,
                  ),
                ),
              )
            else
        ...
        children: [
          ...
          Expanded(
            child: Column(
              ...
              children: [
                Text(context.l10n.accountType(account.accountType),
  ...
  List<Widget> _txSlivers(BuildContext context, TransactionsFeed feed) {
    ...
    for (final tx in feed.items) {
      ...
      if (groups.isNotEmpty && groups.last.key == key) {
        ...
        groups.add(_G(key, l.relativeDay(tx.date), [tx]));
      }
    }
